...
struct  X509Store_t579  : public Object_t
{
	...
	X509Certificate2Collection_t570 * ___list_2;
	...
	X509Store_t593 * ___store_4;
};
struct X509Store_t579_StaticFields{
	...
	Dictionary_2_t109 * ___U3CU3Ef__switchU24mapF_5;
};
