...
struct  ClientSessionInfo_t820  : public Object_t
{
	...
	ByteU5BU5D_t130* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t130* ___masterSecret_5;
};
struct ClientSessionInfo_t820_StaticFields{
