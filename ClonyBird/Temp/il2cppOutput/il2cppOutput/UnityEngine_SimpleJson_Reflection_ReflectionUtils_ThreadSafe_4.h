...
struct  ThreadSafeDictionary_2_t383  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t382 * ____valueFactory_1;
	...
	Dictionary_2_t2144 * ____dictionary_2;
};
